...
function App() {
  ...
  return (
    ...
    <h1  className='blink_me' style={noom ? {color: "green",textAlign:'center',  marginTop:'50px'}  :  {color :"red" ,textAlign:'center', marginTop:'50px'} } > {noom ? "helloo , have a nice day" :  "It seem like There is no name ! please try to enter your name"}</h1>
    <New/>
